...
POSE_EFFICIENTNET = edict()
POSE_EFFICIENTNET.NUM_LAYERS = 50
POSE_EFFICIENTNET.DECONV_WITH_BIAS = False
POSE_EFFICIENTNET.NUM_DECONV_LAYERS = 3
POSE_EFFICIENTNET.NUM_DECONV_FILTERS = [256, 256, 256]
POSE_EFFICIENTNET.NUM_DECONV_KERNELS = [4, 4, 4]
POSE_EFFICIENTNET.FINAL_CONV_KERNEL = 1
POSE_EFFICIENTNET.TARGET_TYPE = 'gaussian'
POSE_EFFICIENTNET.HEATMAP_SIZE = [64, 64]  # width * height, ex: 24 * 32
POSE_EFFICIENTNET.SIGMA = 2

MODEL_EXTRAS = {
    'pose_efficient': POSE_EFFICIENTNET,
}

# common params for NETWORK
config.MODEL = edict()
config.MODEL.NAME = 'pose_efficient'
